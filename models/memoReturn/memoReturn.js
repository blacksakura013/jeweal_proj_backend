...
const MemoReturnItemSchema = new Schema({
...
const MemoReturnSummarySchema = new Schema({
...
const MemoReturnSchema = new Schema(
  {
  ...
  set: decimalSetter(2),
    ...
    items: [MemoReturnItemSchema],
    summary: MemoReturnSummarySchema,
    remark: { type: String },
    note: { type: String }
  },
  { timestamps: true }
...
module.exports = mongoose.model('MemoReturn', MemoReturnSchema);

MemoReturnSchema.set("toJSON", { getters: true });
MemoReturnSchema.set("toObject", { getters: true });